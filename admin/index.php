...
<body>
  ...
  <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
                  ...
                  <a href="add_room_hall.php">
                 <div class="col-md-4 col-sm-4 col-md-4">
                    <div class="dashboard-div-wrapper bk-clr-two">
                        <i  class="fa fa-hotel dashboard-div-icon" ></i>
                        <div class="progress progress-striped active">
  <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 70%">
                 ...
                 <div class="col-md-4 col-sm-4 col-md-4">
                    <div class="dashboard-div-wrapper bk-clr-three">
                        <i  class="glyphicon glyphicon-registration-mark dashboard-div-icon" ></i>
                        <div class="progress progress-striped active">
  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%">
            ...
            <div class="row">
                 <a href="room_services.php">
                 <div class="col-md-4 col-sm-4 col-md-4">
                    <div class="dashboard-div-wrapper bk-clr-four">
                        <i  class=" glyphicon glyphicon-briefcase dashboard-div-icon" ></i>
                        <div class="progress progress-striped active">
  <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
  </div>
                ...
                <a href="payment.php">
                 <div class="col-md-4 col-sm-4 col-md-4">
                    <div class="dashboard-div-wrapper bk-clr-five">
                        <i  class="glyphicon glyphicon-credit-card dashboard-div-icon" ></i>
                        <div class="progress progress-striped active">
  <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 70%">
  </div>
                ...
                <a href="other_payment.php">
                 <div class="col-md-4 col-sm-4 col-md-4">
                    <div class="dashboard-div-wrapper bk-clr-six">
                        <i  class=" glyphicon glyphicon-bitcoin  dashboard-div-icon" ></i>
                        <div class="progress progress-striped active">
  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%">
  </div>
