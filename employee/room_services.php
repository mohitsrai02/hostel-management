        ...
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="col-xs-12"><select class="form-control" style="width: 400px;margin-bottom: 20px">
                                                <option value="select">Select</option>
                                                
                                              </select></div>
                        <button type="button" class="btn btn-info btn-sm" style="margin-bottom : 20px;border-radius: 5px">Add Services</button>
...
<footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
   <center> <button type="button" class="btn btn-danger btn-md" style="margin-top: 60px">Save</button></center>
</div>
